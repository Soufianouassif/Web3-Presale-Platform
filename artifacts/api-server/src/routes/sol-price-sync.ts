...
const _solRpcRaw = process.env.SOLANA_RPC_URL ?? "";
const SOLANA_RPC = (_solRpcRaw.startsWith("http://") || _solRpcRaw.startsWith("https://")) ? _solRpcRaw : "https://api.devnet.solana.com";
