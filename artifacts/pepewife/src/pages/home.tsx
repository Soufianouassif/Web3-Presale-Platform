...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-sans">
      ...
      {/* Hero Section */}
      <section id="hero" className="pt-32 pb-20 lg:pt-40 lg:pb-28 px-4 relative overflow-hidden">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 relative z-10">
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-block bg-secondary/10 text-secondary border border-secondary/20 rounded-full px-4 py-1.5 mb-6 font-semibold animate-pulse">
            ...
            <h1 className="text-5xl lg:text-7xl font-display font-extrabold text-foreground leading-tight mb-6">
              Be Early... Or <span className="text-primary">Cry Later</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <Button size="lg" onClick={() => scrollTo('presale')} className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white rounded-full h-14 px-8 text-lg btn-primary-glow" data-testid="button-buy-hero">
                Buy PWIFE Now
              </Button>
              <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-full h-14 px-8 text-lg border-2" data-testid="button-join-community">
