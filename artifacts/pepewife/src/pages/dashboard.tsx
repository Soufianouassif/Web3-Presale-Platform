  ...
  return (
    <div className="min-h-screen font-sans overflow-x-hidden" style={{ background: "#0a0a0a" }}>
      ...
      <nav className="fixed top-0 w-full z-50 border-b-4 border-[#00ff88]" style={{ background: "#0a0a0a" }}>
          ...
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="relative">
                <button onClick={() => setShowDropdown(!showDropdown)} className="flex items-center gap-1.5 bg-[#00ff88]/10 border-2 border-[#00ff88] text-[#00ff88] rounded-xl px-3 h-9 font-display text-sm tracking-wide whitespace-nowrap shadow-[2px_2px_0px_#2E7D32]">
                  <Wallet className="h-3.5 w-3.5 shrink-0" />
                  <span className="hidden sm:inline">{walletAddress}</span>
                  <ChevronDown className="h-3 w-3" />
                </button>
                {showDropdown && (
                  <div className="absolute end-0 top-full mt-2 w-72 meme-card bg-[#111111] rounded-xl p-3 space-y-2 z-50">
                    <div className="text-xs font-display text-white/40 tracking-wider">{t.nav.wallet}</div>
                    <div className="bg-[#111111] rounded-lg px-3 py-2 border border-[#ffe000]/30">
                      ...
                      <div className="mt-1.5 flex items-center gap-1">
                        ...
                        <span className="text-[9px] font-display tracking-wider text-white/40">
                          Solana Mainnet
                        </span>
                      </div>
                    </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden border-t-3 border-[#1a1a2e]" style={{ background: "#111111" }}>
      ...
      <div className="pt-20 sm:pt-24 pb-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="mb-8">
            <div className="sticker bg-[#00ff88] text-black mb-4 text-sm inline-block" style={{ transform: "rotate(-1deg)" }}>{t.dashboard.connected}</div>
            ...
            <p className="text-lg text-white/60 font-bold">{t.dashboard.subtitle}</p>
          </div>

          <div className="flex gap-6">
            <div className="hidden lg:block w-56 shrink-0">
              <div className="meme-card bg-[#111111] rounded-2xl p-3 sticky top-24 space-y-1">
                {tabs.map(tb => (
                  <button key={tb.id} onClick={() => setActiveTab(tb.id)} className={`flex items-center gap-2 w-full text-start px-3 py-2.5 rounded-xl font-display text-base tracking-wide transition-all ${activeTab === tb.id ? "bg-[#00ff88]/10 text-[#00ff88] border-2 border-[#00ff88] shadow-[2px_2px_0px_#00cc66]" : "text-[#1a1a2e] hover:bg-white/5 border-2 border-transparent"}`}>
                    <span>{tb.icon}</span> <span>{tb.label}</span>
                  </button>
                ))}
              </div>
            ...
            <div className="flex-1 min-w-0">
              <div className="lg:hidden mb-6">
                <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
                  {tabs.map(tb => (
                    <button key={tb.id} onClick={() => setActiveTab(tb.id)} className={`flex items-center gap-1.5 px-4 py-2 rounded-full font-display text-sm tracking-wide whitespace-nowrap border-2 transition-all shrink-0 ${activeTab === tb.id ? "bg-[#00ff88] text-black border-[#000] shadow-[3px_3px_0px_#ffe000]" : "bg-[#111111] text-[#1a1a2e] border-white/20 hover:border-[#1a1a2e]"}`}>
                      <span>{tb.icon}</span> <span>{tb.label}</span>
                    </button>
                  ))}
                </div>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                    {[
                      ...
                      },
                      {
                        ...
                        color: "#42A5F5", shadow: "#1565C0", bg: "bg-[#111111]",
                      },
                      {
                        ...
                        color: "#b8860b", shadow: "#8B6914", bg: "bg-[#111111]",
                      },
                      {
                      ...
                      <div key={card.label} className={`meme-card ${card.bg} rounded-2xl p-4 sm:p-5`} style={{ borderColor: card.color, boxShadow: `${isRTL ? "-4px" : "4px"} 4px 0px ${card.shadow}` }}>
                        ...
                        <div className="text-xs text-white/40 font-bold">{card.sub}</div>
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="meme-card bg-[#111111] rounded-3xl overflow-hidden">
                      ...
                      <div className="p-5 sm:p-6 space-y-5">
                        <div className="text-center">
                          <div className="sticker bg-[#ffe000] text-black text-sm inline-block mb-2" style={{ transform: "rotate(-1deg)" }}>{t.dashboard.presaleComingSoon}</div>
                        ...
                        <div className="space-y-2">
                          <div className="flex justify-between text-sm font-bold">
                            ...
                            <span className="text-white/60 font-nums tracking-wide">{presaleFilled}% — Stage {currentStage + 1}/4</span>
                          </div>
                          ...
                          <div className="flex gap-1">
                            {STAGE_DATA.map((s, i) => (
                              <div key={i} className={`flex-1 text-center rounded-lg py-1 border ${i === currentStage ? "border-[#00ff88] bg-[#00ff88]/10" : "border-transparent"}`}>
                                <div className="text-[9px] font-display tracking-wide text-white/50">S{s.stage}</div>
                                <P v={s.price} className="text-[9px] font-display font-bold" style={{ color: s.color }} />
                              </div>
                            ))}
                          </div>
                          <div className="text-center text-[10px] font-display text-white/40 tracking-wider">
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          {[
                            ...
                            { l: t.presale.list, v: LISTING_PRICE,        sub: "CEX",    bg: "bg-[#FFD54F]/20", bc: "border-[#ffe000]", tc: "text-[#ffe000]" },
                          ].map(p => (
                            <div key={p.l} className={`${p.bg} border-2 ${p.bc} rounded-xl p-2.5 text-center`}>
                              <div className="text-[10px] font-display tracking-wider text-white/50">{p.l}</div>
                              <P v={p.v} className={`text-[11px] font-display ${p.tc} tracking-wider font-bold`} />
                              <div className="text-[9px] font-display text-white/40 tracking-wide">{p.sub}</div>
                            </div>
                          ))}
                        </div>

                        {/* Live price ticker */}
                        <div className="bg-[#111111]/4 border border-white/10 rounded-xl px-3 py-2 flex items-center justify-between gap-2">
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-2 gap-2">
                            <button onClick={() => { setCurrency("SOL"); setBuyAmount(""); }}
                              className={`flex flex-col items-center justify-center rounded-xl h-11 font-display tracking-wide border-2 transition-all ${currency === "SOL" ? "bg-[#14F195]/15 border-[#14F195] text-[#0a9060] shadow-[3px_3px_0px_#0a9060]" : "bg-[#111111] border-gray-200 text-gray-400 hover:border-gray-300"}`}>
                            ...
                            <button onClick={() => { setCurrency("USDT_SPL"); setBuyAmount(""); }}
                              className={`flex flex-col items-center justify-center rounded-xl h-11 font-display tracking-wide border-2 transition-all ${currency === "USDT_SPL" ? "bg-[#26A17B]/15 border-[#26A17B] text-[#1a7a5e] shadow-[3px_3px_0px_#1a7a5e]" : "bg-[#111111] border-gray-200 text-gray-400 hover:border-gray-300"}`}>
                          ...
                          <div className="flex items-start gap-2 bg-amber-950 border-2 border-amber-400 rounded-xl px-3 py-2 mt-2">
                            <span className="text-base mt-0.5">⚠️</span>
                            <div>
                              <p className="text-[11px] font-bold text-amber-300 leading-tight">{t.presale.warnTitle}</p>
                        ...
                        <div className="space-y-2">
                          <div className="relative">
                            <input
                              ...
                              className={`w-full h-12 ps-4 pe-28 text-base rounded-xl border-2 font-bold bg-[#111111] text-white outline-none transition-colors ${amountError ? "border-red-400 focus:border-red-500" : buyAmount && !amountError ? "border-[#4CAF50] focus:border-[#4CAF50]" : "border-[#333] focus:border-[#ffe000]"}`}
                              style={{ direction: "ltr" }}
                            />
                          ...
                          {amountError ? (
                            ...
                            <p className="text-[10px] text-white/40 font-bold px-1">
                          ...
                          <div className={`border-2 rounded-xl px-3 py-2.5 transition-colors ${tokensOut > 0 ? "bg-[#00ff88]/10 border-[#00ff88]/50" : "bg-[#111111] border-gray-200"}`}>
                            ...
                            {tokensOut > 0 && currency === "SOL" && (
                              <p className="text-[10px] text-white/30 font-bold mt-0.5 text-end">
                          ...
                          {dashTxSig && (
                            <div className="bg-[#00ff88]/10 border-2 border-[#00ff88] rounded-xl p-3 flex items-start gap-2">
                    ...
                    <div className="space-y-4">
                      <div className="meme-card bg-[#111111] rounded-2xl p-5">
                        ...
                        <div className="space-y-3">
                          {presaleStages.map((s) => (
                            <div key={s.stage} className={`rounded-2xl p-4 border-3 transition-all ${s.status === "active" ? "" : s.status === "sold-out" ? "border-white/15 bg-white/5" : "border-white/10 bg-white/3"}`} style={s.status === "active" ? { borderColor: s.color, boxShadow: `${isRTL ? "-4px" : "4px"} 4px 0px ${s.shadow}` } : {}}>
                              <div className="flex items-center justify-between mb-2">
                                <div className="flex items-center gap-2">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-xs text-white/40 font-bold">{s.tokens} $PWIFE • {s.total} {t.dashboard.raised}</div>
                                  </div>
                                </div>
                                <div className="text-end">
                                  <div className="font-display text-lg tracking-wider" style={{ color: s.color }}>{s.price}</div>
                                  <span className={`inline-block text-[10px] font-display tracking-wider px-2 py-0.5 rounded-full border ${s.status === "active" ? "bg-[#FF4D9D]/10 border-[#FF4D9D] text-[#FF4D9D]" : s.status === "sold-out" ? "bg-[#4CAF50]/10 border-[#4CAF50] text-[#4CAF50]" : "bg-[#111111]/5 border-white/20 text-white/40"}`}>
                                    {s.status === "active" ? t.dashboard.live : s.status === "sold-out" ? t.dashboard.soldOut : t.dashboard.locked}
                                  </span>
                                </div>
                              </div>
                              <div className="h-2.5 rounded-full bg-[#111111]/10 overflow-hidden border border-white/15">
                              ...
                              <div className="flex justify-between mt-1">
                                ...
                                <span className="text-[10px] text-white/30 font-nums">{s.tokens} $PWIFE</span>
                              </div>
                            </div>
                          ))}
                        </div>
                      ...
                      <div className="meme-card bg-[#111111] rounded-2xl p-4 border-[#ffe000] shadow-[3px_3px_0px_#cc9900]">
                        <div className="flex items-center gap-3">
                          <div className="text-3xl">📊</div>
                          <div className="flex-1">
                            <div className="font-display text-sm text-[#ffe000] tracking-wider">{t.dashboard.totalPresaleProgress}</div>
                            <div className="h-3 rounded-full bg-[#111111]/10 overflow-hidden mt-1 border border-white/15">
                              <div className="h-full rounded-full bg-gradient-to-r from-[#4CAF50] via-[#FF4D9D] to-[#42A5F5]" style={{ width: "0%" }} />
                            </div>
                            <div className="flex justify-between mt-1">
                              <span className="text-[10px] font-display text-[#ffe000] tracking-wider">0 / 0 $PWIFE</span>
                              <span className="text-[10px] font-display text-[#ffe000] tracking-wider">0%</span>
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl p-5">
                    ...
                    <div className="space-y-4">
                      {[
                        ...
                        <div key={ti.tier} className={`flex items-center gap-3 p-3 rounded-xl border-2 ${ti.active ? "border-[#00ff88] bg-[#00ff88]/10 shadow-[3px_3px_0px_#00cc66]" : "border-white/10 bg-white/3"}`}>
                          <span className="text-lg font-display tracking-wider shrink-0">{ti.tier}</span>
                          <div className="flex-1">
                            <div className="h-2 rounded-full bg-[#111111]/10 overflow-hidden">
                              <div className="h-full rounded-full bg-[#4CAF50] transition-all" style={{ width: `${ti.progress}%` }} />
                            </div>
                          </div>
                          <span className="text-xs font-display text-white/40 tracking-wide shrink-0">{ti.min}{ti.max && ` - ${ti.max}`}</span>
                          <span className={`sticker text-xs ${ti.active ? "bg-[#4CAF50] text-white" : "bg-[#111111]/10 text-white/40"}`} style={{ transform: "none" }}>+{ti.bonus}</span>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              {activeTab === "purchases" && (
                <div className="space-y-5">
                  {/* ── Total summary card ── */}
                  <div className="meme-card bg-[#00ff88]/10 rounded-2xl p-5 border-[#00ff88]" style={{ boxShadow: `${isRTL ? "-4px" : "4px"} 4px 0px #2E7D32` }}>
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        <div className="font-display text-sm text-[#4CAF50] tracking-wider">{t.dashboard.totalPurchased}</div>
                        {buyerLoading ? (
                          <div className="text-2xl font-nums text-white/40 tracking-wider">…</div>
                        ) : (
                          <>
                            <div className="text-3xl font-nums text-[#1a1a2e] tracking-wider">
                              {fmt(userPwife)} <span className="text-base text-white/40">$PWIFE</span>
                            </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="meme-card bg-[#111111] rounded-2xl p-4 border-[#14F195]" style={{ boxShadow: `${isRTL ? "-3px" : "3px"} 3px 0px #0a9060` }}>
                    ...
                    <div className="meme-card bg-[#111111] rounded-2xl p-4 border-[#26A17B]" style={{ boxShadow: `${isRTL ? "-3px" : "3px"} 3px 0px #1a7a5e` }}>
                      <div className="flex items-center gap-2 mb-2">
                      ...
                      <div className="text-xs text-white/40 font-bold mt-0.5">≈ ${userUsdtPaid.toFixed(2)}</div>
                    </div>
                  </div>
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl overflow-hidden">
                    ...
                    <div className="p-5">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <button onClick={refreshBuyerData} className="text-xs font-display text-white/40 hover:text-[#FF4D9D] transition-colors tracking-wide">
                      ...
                      {buyerLoading ? (
                        <div className="text-center py-8">
                          ...
                          <p className="font-display text-white/40 tracking-wider text-sm">Loading on-chain data…</p>
                        </div>
                      ) : !hasPurchased ? (
                        <div className="text-center py-10">
                          <div className="text-5xl mb-3">🛒</div>
                          <p className="font-display text-lg text-white/40 tracking-wider">{t.dashboard.noPurchases}</p>
                          <p className="text-sm text-white/30 font-bold">{t.dashboard.noPurchasesDesc}</p>
                        </div>
                      ) : (
                        <div className="space-y-3">
                          <div className="bg-[#00ff88]/5 border-2 border-[#00ff88]/40 rounded-xl p-4">
                          ...
                          {userSolPaid > 0 && (
                            <div className="bg-white/5 border border-[#14F195]/30 rounded-xl px-4 py-3 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <SiSolana size={14} className="text-[#14F195]" />
                                <span className="text-sm font-bold text-white/70">SOL paid</span>
                              </div>
                              <span className="font-display text-[#0a9060] tracking-wide">{userSolPaid.toFixed(4)} SOL</span>
                            </div>
                          )}
                          {userUsdtPaid > 0 && (
                            <div className="bg-white/5 border border-[#26A17B]/30 rounded-xl px-4 py-3 flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <SiTether size={14} className="text-[#26A17B]" />
                                <span className="text-sm font-bold text-white/70">USDT paid</span>
                              </div>
                              <span className="font-display text-[#1a7a5e] tracking-wide">{userUsdtPaid.toFixed(2)} USDT</span>
                            </div>
                          )}
                          <div className="bg-[#ffe000]/10 border border-[#ffe000] rounded-xl px-4 py-3 flex items-center justify-between">
                            <span className="text-sm font-bold text-white/70">💰 {t.dashboard.totalInvested}</span>
                            <span className="font-display text-[#ffe000] tracking-wide">${userTotalUSD.toFixed(2)}</span>
                          </div>
                        </div>
                      )}
                    </div>
                ...
                <div className="space-y-6">
                  <div className="meme-card bg-[#111111] rounded-2xl overflow-hidden">
                    ...
                    <div className="p-6 sm:p-8 text-center">
                      ...
                      <p className="text-white/50 font-bold mb-6 max-w-md mx-auto">
                        {t.dashboard.claimingDesc}
                      </p>
                      <div className="grid grid-cols-2 gap-4 max-w-sm mx-auto mb-6">
                        <div className="meme-card bg-[#00ff88]/10 rounded-2xl p-4 border-[#00ff88] shadow-[3px_3px_0px_#00cc66]">
                          ...
                          <div className="text-xs text-white/40 font-bold">$PWIFE</div>
                        </div>
                      ...
                      <div className="meme-card bg-[#ffe000]/10 rounded-2xl p-4 max-w-sm mx-auto mb-6 border-[#ffe000] shadow-[3px_3px_0px_#cc9900]">
                        <div className="flex items-center gap-2 justify-center">
                          <Shield className="h-4 w-4 text-[#ffe000]" />
                          <span className="text-sm font-display text-[#ffe000] tracking-wider">{t.dashboard.claimStatus}</span>
                        </div>
                      ...
                      <p className="text-xs text-white/30 font-bold mt-4">{t.dashboard.claimDisclaimer}</p>
                    </div>
                  </div>
                </div>
              )}
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl overflow-hidden">
                    ...
                    <div className="p-5 space-y-5">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="sticker bg-[#ffe000] text-black mb-3 text-sm inline-block" style={{ transform: "rotate(2deg)" }}>{t.presale.referralBanner}</div>
                        ...
                        <button
                          ...
                          disabled={refLoading}
                          className="shrink-0 mt-1 flex items-center gap-1 text-xs font-display text-white/40 hover:text-[#FF4D9D] transition-colors tracking-wide disabled:opacity-50"
                        >
                      ...
                      <div>
                        ...
                        {myRefUrl ? (
                          <div className="flex gap-2">
                            <Input readOnly value={myRefUrl} className="h-11 rounded-xl border-2 border-[#00ff88] bg-[#111111] text-white font-mono text-xs" />
                            <button
                              onClick={() => {
                              ...
                              className={`btn-meme h-11 px-4 rounded-xl shrink-0 ${refCopied ? "bg-[#00ff88]" : "bg-[#ffe000]"} text-black`}
                            >
                              {refCopied ? <Check className="h-4 w-4" /> : <Copy className="h-4 w-4" />}
                            </button>
                          </div>
                        ) : (
                          <div className="h-11 rounded-xl border-2 border-dashed border-white/20 bg-[#111111] flex items-center px-3 animate-pulse">
                            <span className="font-display text-xs text-white/40 tracking-wider">{t.presale.generatingLink}</span>
                          </div>
                        )}
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        {[
                          ...
                          <div key={s.l} className={`${s.bg} rounded-xl p-3 text-center border-2 ${s.bc}`}>
                            ...
                            <div className="text-[10px] font-display text-white/40 tracking-wider mt-0.5">{s.l}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl p-5">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        return (
                          <div key={p.reward} className="bg-[#111111] rounded-xl p-3 border-2 border-[#ffe000]/30">
                            <div className="flex justify-between text-xs font-display tracking-wider mb-1.5">
                              <span className="text-[#1a1a2e]">{p.reward}</span>
                              <span className="text-white/40">{current}/{p.target} {t.dashboard.referralsLabel}</span>
                            </div>
                            <div className="h-3 rounded-full bg-[#111111]/10 overflow-hidden border border-white/20">
                    ...
                    <div className="meme-card bg-[#111111] rounded-2xl p-5">
                      ...
                      <div className="space-y-2">
                        {refStats.recentReferrals.map((r, i) => (
                          <div key={`recent-${i}`} className="flex items-center gap-2 rounded-xl px-3 py-2 border-2 bg-[#111111] border-[#ffe000]/50">
                            <span className="font-mono text-xs text-white/50 flex-1">
                            ...
                            <span className={`text-[10px] px-2 py-0.5 rounded-full font-display ${r.status === "paid" ? "bg-[#00ff88]/20 text-[#00ff88]" : "bg-[#ffe000]/20 text-[#ffe000]"}`}>
                              {r.status}
                            </span>
                          </div>
                        ))}
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl p-5">
                    ...
                    <div className="space-y-2">
                      {leaderboard.length === 0
                        ? [{ r: "🥇" }, { r: "🥈" }, { r: "🥉" }].map((x, i) => (
                            <div key={`ph-${i}`} className="flex items-center gap-2 rounded-xl px-3 py-2 border-2 bg-[#111111] border-[#ffe000]/50">
                        ...
                        : leaderboard.slice(0, 5).map((entry, i) => (
                            <div key={`lb-${i}`} className="flex items-center gap-2 rounded-xl px-3 py-2 border-2 bg-[#111111] border-[#ffe000]/50">
                  ...
                  <div className="meme-card bg-[#111111] rounded-2xl overflow-hidden">
                    ...
                    <div className="p-5">
                      ...
                      {buyerTxsLoading ? (
                        <div className="text-center py-8">
                          <div className="text-3xl mb-2 animate-spin inline-block">⏳</div>
                          <p className="font-display text-white/40 tracking-wider text-sm">Loading transactions…</p>
                        </div>
                      ) : buyerTxs.length === 0 ? (
                        <div className="text-center py-10">
                          <div className="text-5xl mb-3">📜</div>
                          <p className="font-display text-lg text-white/40 tracking-wider">{t.dashboard.noTransactions}</p>
                          <p className="text-sm text-white/30 font-bold">{t.dashboard.noTransactionsDesc}</p>
                        </div>
                      ) : (
                        <div className="space-y-2">
                          {buyerTxs.map((tx, i) => {
                            const date = tx.blockTime
                              ...
                              : "—";
                            return (
                              <div key={tx.signature} className="flex items-center gap-3 rounded-xl border-2 border-white/10 bg-white/3 px-4 py-3 hover:bg-white/5 transition-colors">
                                ...
                                <div className="flex-1 min-w-0">
                                  <div className="font-mono text-[11px] text-white/70 truncate">{tx.signature.slice(0, 20)}…{tx.signature.slice(-8)}</div>
                                  <div className="text-[10px] text-white/40 font-bold">{date}</div>
                                </div>
                                <a
                          ...
                          <p className="text-center text-[10px] text-white/30 font-bold pt-2">
